export const VERSION_MAJOR = 0, VERSION_MINOR = 3, // will only change when the data format changes
PATCH = 1; // will change only with published commits, the in-beetween development versions are not counted
