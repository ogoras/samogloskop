...
export default class SettingsView extends View {
    ...
    createConsentSection() {
        ...
        if (localStorage.getItem("accepted") === "true") {
            ...
            button.addEventListener("click", () => {
                if (!confirm("Czy na pewno chcesz wycofać zgodę i wyczyścić dane z pamięci lokalnej? Utracisz wszystkie swoje dane."))
                    return;
            ...
            secondButton.addEventListener("click", () => {
                if (!confirm("Czy na pewno chcesz wycofać zgodę na korzystanie z pamięci lokalnej? Utracisz wszystkie swoje dane po odświeżeniu lub zamknięciu okna przeglądarki."))
                    return;
                this.controller.lsm.clear();
    ...
    createPresetSection() {
        ...
        div.appendChild(title);
        new PresetView(this.controller, div, this.controller.lsm.preset.index, () => {
            const nextElement = div.nextElementSibling;
            div.remove();
    ...
    createDeleteVowelsSection() {
        ...
        button.onclick = () => {
            if (!confirm("Czy na pewno chcesz usunąć wszystkie dane o Twoich polskich samogłoskach?"))
                return;
